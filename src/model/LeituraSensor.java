...
//O dado bruto capturado por um sensor em um momento exato do tempo.
public class LeituraSensor {
    ...
    //Valida se o dado lido faz sentido ou se indica um perigo imediato com base no tipo do sensor.
