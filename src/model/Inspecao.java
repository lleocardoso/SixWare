...
//Registro de uma vistoria manual feita no campo (Ex: Agrônomo analisando as folhas das plantas).
public class Inspecao {
    ...
    //Adiciona o registro de uma praga encontrada durante esta inspeção.
