...
//Representa a área (A fazenda/propriedade).
public class Solo {
    private int id;
    private String nome;
    ...
    //Agrega e retorna um panorama geral (dashboard) de todas as zonas filhas. Consolida a visão da propriedade em tempo real.
