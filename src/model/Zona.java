...
//Representa um setor específico de controle (Ex: Canteiro A, Setor de Soja). Agrupa dispositivos IoT e válvulas de um microclima específico.
public class Zona {
    private int id;
    private String nome;
    private String solo;
    ...
    //Calcula as médias de umidade e temperatura baseadas em todos os sensores ativos na zona.
    //@return Objeto de StatusSolo com os valores processados e flag de necessidade de irrigação.
    public StatusSolo getStatusSolo() {
        float umidadeMedia = 0;
        float tempMedia = 0;
        int totalLeituras = 0;

        // Repete por todos os hardwares vinculados a este setor
        ...
        // Checa contra os parâmetros técnicos ideais daquela zona
